  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        <h3 className="text-2xl font-semibold text-slate-900 dark:text-white mb-3 leading-tight group-hover:text-black dark:group-hover:text-neutral-400 transition-colors">
          {blog.title}
        </h3>
