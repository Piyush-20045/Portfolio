...
const Skills = () => {
  return (
    <section
      id="skills"
      className="w-full pt-14 pb-8 px-4 md:px-8 scroll-mt-8 border-y border-slate-200 dark:border-neutral-800"
    >
      <div className="container mx-auto text-start">
        <motion.h2
          className="text-3xl md:text-4xl font-semibold text-gray-900 dark:text-white mb-3"
        ...
        <motion.p
          className="text-lg text-gray-800 dark:text-gray-300 font-medium mb-4 max-w-2xl"
          initial={{ opacity: 0 }}
