...
import { GridBackground } from "../ui/lightswind/grid-dot-backgrounds";
    ...
    >
      ...
      >
        ...
        <motion.form
          ...
          ref={form}
          onSubmit={sendMail}
          className="w-11/12 md:w-full mx-3 mt-5 px-4 sm:px-6 md:px-12 py-8 flex flex-col gap-4 border border-gray-400 rounded-2xl bg-gray-200 dark:bg-gray-800"
        >
