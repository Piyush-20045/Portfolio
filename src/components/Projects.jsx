...
const Projects = () => {
  return (
    ...
    >
      <section
        id="projects"
        className="md:px-14 lg:px-36 px-4 py-20 scroll-mt-8"
      >
        <motion.div
        ...
        >
          ...
          <p className="text-lg text-gray-800 dark:text-gray-400 font-semibold max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          {projectsData.map((project, index) => (
            <motion.div
              key={index}
              className="bg-gray-100 dark:bg-gray-800 rounded-xl shadow-black dark:shadow-amber-100 overflow-hidden hover:shadow-sm transition-shadow duration-300 shadow-md"
