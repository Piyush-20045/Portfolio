...
const Hero = () => {
  return (
    <div className="min-h-screen py-20 flex flex-col md:flex-row justify-center items-center md:gap-5 text-gray-800 dark:text-gray-200">
      ...
      <div className="text-center md:text-start ml-3 mr-2">
        ...
        <p className="mt-3 text-lg text-gray-800 dark:text-gray-400 max-w-xl">
        ...
        <div className="mt-8 mx-3 md:mx-0 md:mt-6 flex justify-between text-gray-400 text-sm md:text-base">
          <span className="flex text-gray-600 dark:text-gray-500">
            <img className="w-5 h-5 bg-gray-300 dark:bg-gray-400 rounded" src="/location.svg" />
            &nbsp;Mumbai, India.
          </span>
          <div className="flex gap-2 md:gap-6 mr-2 md:mr-12 text-gray-600">
            <a
              className="flex items-center font-medium hover:text-gray-500 dark:hover:text-gray-200 active:underline"
              href="https://www.linkedin.com/in/piyush-yadav-a4b164260/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img className="w-5 h-5 dark:bg-white rounded" src={linkedinIcon} />
              &nbsp;Linkedin
            </a>
            <a
              className="flex items-center font-medium hover:text-gray-500 dark:hover:text-gray-200 active:underline"
            ...
            >
              <img
                className="w-5 h-5 rounded-full dark:bg-white"
                src="/github.svg"
              />
              &nbsp;Github
            </a>
